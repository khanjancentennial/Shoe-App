...
class CustomerProfileScreen extends StatefulWidget {
  String? userId;
  CustomerProfileScreen({super.key,this.userId});
...
class _CustomerProfileScreenState extends State<CustomerProfileScreen> {
  ...
  Future<void>? getDetails() async {
    if (this.mounted) {
      ...
      // print(userId);
      setState(() {});
      Provider.of<UserProfileProvider>(context, listen: false).getUserDetails(widget.userId!);
    }
  }
                      ...
                      child: Padding(
                        ...
                        Consumer<UserProfileProvider>(
                            builder: (_, getUserDetails, child) =>
                                ...
                                isFirstTime ?
                                Consumer<UpdateUserProfileProvider>(
  ...
  void validations() async {
    ...
    if(Provider.of<UpdateUserProfileProvider>(context,listen: false).isMale
        || Provider.of<UpdateUserProfileProvider>(context,listen: false).isFemale
    ...
    if(_formKey.currentState!.validate()){
      ...
      Provider.of<UpdateUserProfileProvider>(context, listen: false).addUserDetails(
          context,
        ...
        Provider.of<UpdateUserProfileProvider>(context,listen: false).isMale ? "Male" : "Female",
